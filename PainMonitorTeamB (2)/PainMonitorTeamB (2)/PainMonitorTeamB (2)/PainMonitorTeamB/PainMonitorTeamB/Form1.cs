    ...
    public partial class Form1 : Form
    {
        ...
        private void sndmail()
        {
            try
            {
                ...
                MailAddress To = new MailAddress("joshuavoss@gmail.com");// gets the email addresss from the settings 
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                //sets variable names for easiier mangment 
               string date = dataGridView1.Rows[x].Cells[0].Value.ToString();
               string medication = dataGridView1.Rows[x].Cells[1].Value.ToString();
               string pain = dataGridView1.Rows[x].Cells[2].Value.ToString();
                string location = dataGridView1.Rows[x].Cells[3].Value.ToString();
                string sym  = dataGridView1.Rows[x].Cells[4].Value.ToString();
              
                
                textBox1.Text = textBox1.Text + 
                  "Date: "+ date + Environment.NewLine +
                  "Medication: " + medication + Environment.NewLine+ 
                  "Pain: " + pain + Environment.NewLine +   
                  "Location: " + location + Environment.NewLine +   
                  "Symptoms: " + sym + Environment.NewLine + 
                  "===========================================" + Environment.NewLine;
